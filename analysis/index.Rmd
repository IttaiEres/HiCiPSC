...
*  [Orthogonal analysis with gene expression data collected from the same cell lines--Figures 6, S14, S15, S19](gene_expression.html)
*  [Epigenetic annotation enrichment analyses on the linear-modeling significant Hi-C hits--Figures 7, S16, S17, S18](enrichment.html)
...
#### TAD Analyses
*  [TAD Analyses--Figures 4, S11, S12, S13](TADs.html)

#### License
Copyright (c) 2019, Ittai Eres, Kaixuan Luo, Chiaowen Joyce Hsiao, Lauren E. Blake, and Yoav Gilad.
All source code and software in this repository are made available under the terms of the [GNU GPL v3][]
