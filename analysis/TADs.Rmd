...
intra.ortho.plotter <- function(species){
  ...
  if(species=="H"){
    myplot <- ggplot(data=ggbounds, aes(x=Resolution, group=Resolution, y=Count, fill=as.factor(Individuals))) + geom_bar(stat="identity") + ggtitle("TAD Orth. Boundary Conservation, Humans") +xlab("Resolution of Analysis") + ylab("Boundary Count")
  }
   if(species=="C"){
    myplot <- ggplot(data=ggbounds, aes(x=Resolution, group=Resolution, y=Count, fill=as.factor(Individuals))) + geom_bar(stat="identity") + ggtitle("TAD Orth. Boundary Conservation, Chimps") +xlab("Resolution of Analysis") + ylab("Boundary Count")
   }
  print(myplot)
}
...
intra.full.plotter <- function(species){
  ...
  if(species=="H"){
    myplot <- ggplot(data=ggbounds, aes(x=Resolution, group=Resolution, y=Count, fill=as.factor(Individuals))) + geom_bar(stat="identity") + ggtitle("TAD Boundary Conservation, Humans") +xlab("Resolution of Analysis") + ylab("Boundary Count")
  }
   if(species=="C"){
    myplot <- ggplot(data=ggbounds, aes(x=Resolution, group=Resolution, y=Count, fill=as.factor(Individuals))) + geom_bar(stat="identity") + ggtitle("TAD Boundary Conservation, Chimps") +xlab("Resolution of Analysis") + ylab("Boundary Count")
   }
  print(myplot)
}
options(scipen=999)
...
#Taking the mean of each pairwise comparison. Kind of complex, prefer to just use the individual vectors as below:
...
domain.plotter("rao", intra.ymax = 11000, inter.ymax = 8200)
...
intra.ortho.plotter <- function(species){
  ...
  if(species=="H"){
    myplot <- ggplot(data=ggbounds, aes(x=Resolution, group=Resolution, y=Count, fill=as.factor(Individuals))) + geom_bar(stat="identity") + ggtitle("Intraspecies TAD Boundary Variance, Humans") +xlab("Resolution of Analysis") + ylab("Boundary Count") + guides(fill=guide_legend(title="# Individuals")) + coord_cartesian(ylim=c(0, 2250))
  }
   if(species=="C"){
    myplot <- ggplot(data=ggbounds, aes(x=Resolution, group=Resolution, y=Count, fill=as.factor(Individuals))) + geom_bar(stat="identity") + ggtitle("Intraspecies TAD Boundary Variance, Chimpanzees") +xlab("Resolution of Analysis") + ylab("Boundary Count") + guides(fill=guide_legend(title="# Individuals")) + coord_cartesian(ylim=c(0, 2250))
   }
  print(myplot)
}
...
intra.full.plotter <- function(species){
  ...
  if(species=="H"){
    myplot <- ggplot(data=ggbounds, aes(x=Resolution, group=Resolution, y=Count, fill=as.factor(Individuals))) + geom_bar(stat="identity") + ggtitle("Intraspecies TAD Boundary Variance, Humans") +xlab("Resolution of Analysis") + ylab("Boundary Count")
  }
   if(species=="C"){
    myplot <- ggplot(data=ggbounds, aes(x=Resolution, group=Resolution, y=Count, fill=as.factor(Individuals))) + geom_bar(stat="identity") + ggtitle("Intraspecies TAD Boundary Variance, Chimps") +xlab("Resolution of Analysis") + ylab("Boundary Count")
   }
  print(myplot)
}

intra.ortho.plotter("H") #FIGS5E
intra.ortho.plotter("C") #FIGS5F
#intra.full.plotter("H")
#intra.full.plotter("C")
...
domain.plotter <- function(type, inter.ymax, intra.ymax){
    ...
    plot.1 <- ggplot(data=inter.1, aes(x=resolution, group=resolution, y=value, fill=variable)) + geom_bar(stat="identity") + ggtitle("Interspecies Domain Conservation, TopDom, Stringency=1") + xlab("Resolution of Analysis") + ylab("Domain Count") + guides(fill=guide_legend(title="Species of Discovery")) + theme(plot.title=element_text(hjust=0.3)) + scale_fill_manual(name="Conservation", values=c("#00BA38",  "#619CFF", "#F8766D"), labels=c("Chimpanzee", "Human", "Shared")) + coord_cartesian(ylim=c(0, inter.ymax))
    plot.2 <- ggplot(data=inter.2, aes(x=resolution, group=resolution, y=value, fill=variable)) + geom_bar(stat="identity") + ggtitle("Interspecies Domain Conservation, TopDom, Stringency=2") + xlab("Resolution of Analysis") + ylab("Domain Count") + guides(fill=guide_legend(title="Species of Discovery")) + theme(plot.title=element_text(hjust=0.3)) + scale_fill_manual(name="Conservation", values=c("#00BA38",  "#619CFF", "#F8766D"), labels=c("Chimpanzee", "Human", "Shared")) + coord_cartesian(ylim=c(0, inter.ymax))
    plot.3 <- ggplot(data=inter.3, aes(x=resolution, group=resolution, y=value, fill=variable)) + geom_bar(stat="identity") + ggtitle("Interspecies Domain Conservation, TopDom, Stringency=3") + xlab("Resolution of Analysis") + ylab("Domain Count") + guides(fill=guide_legend(title="Species of Discovery")) + theme(plot.title=element_text(hjust=0.3)) + scale_fill_manual(name="Conservation", values=c("#00BA38",  "#619CFF", "#F8766D"), labels=c("Chimpanzee", "Human", "Shared")) + coord_cartesian(ylim=c(0, inter.ymax))
    plot.4 <- ggplot(data=inter.4, aes(x=resolution, group=resolution, y=value, fill=variable)) + geom_bar(stat="identity") + ggtitle("Interspecies Domain Conservation, TopDom, Stringency=4") + xlab("Resolution of Analysis") + ylab("Domain Count") + guides(fill=guide_legend(title="Species of Discovery")) + theme(plot.title=element_text(hjust=0.3)) + scale_fill_manual(name="Conservation", values=c("#00BA38",  "#619CFF", "#F8766D"), labels=c("Chimpanzee", "Human", "Shared")) + coord_cartesian(ylim=c(0, inter.ymax))
    print(intra.h.plot)
    print(intra.c.plot)
    print(plot.1)
    print(plot.2)
...
domain.plotter("rao", intra.ymax=12000, inter.ymax=12000) 
domain.plotter("loj", intra.ymax=12000, inter.ymax=12000) #I like these results better. And it makes more intuitive sense to me.
```
