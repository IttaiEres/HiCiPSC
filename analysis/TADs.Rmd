...
# Interspecies TAD Boundary Conservation on Juicer Merged Data
...
# Interspecies TAD Body Conservation on Juicer Merged Data
...
#FIG4A
```
# Inter- and intra-species TAD Boundary Variance on Individual-level Arrowhead Inferences
...
#FIG4C
dis <- heatmaply(test, main="Pairwise Proportions of Shared TAD Boundaries @ 10kb", k_row=2, k_col=2, symm=TRUE, margins=c(50, 50, 30, 30), cellnote_size=10, fontsize_row=18, fontsize_col=18)
orca(dis, file="~/Desktop/Fig4D.pdf") #Note that this just created a ~ folder in the hicipsc directory, didn't redirect to home folder.
####
...
# Inter- and intra-species TAD Body Variance on Individual-level Arrowhead Inferences
...
Sys.setenv('MAPBOX_TOKEN'='pk.eyJ1IjoiaXR0YWllcmVzIiwiYSI6ImNqeHVwanphejE3bjIzcHFmY2FvYXIxZXUifQ.rs3I8LoxJcqWBsIhVDiJCQ')
#FIG4C
dis <- heatmaply(clust2, main="Pairwise Proportions of Shared TADs @ 10kb", k_row=2, k_col=2, symm=TRUE, margins=c(50, 50, 30, 30), cellnote_size=10, fontsize_row=18, fontsize_col=18)
orca(dis, file="~/Desktop/Fig4C.pdf") #Note that this just created a ~ folder in the hicipsc directory, didn't redirect to home folder.
...
```
# Inter- and intra-species TAD Boundary Variance on Individual-level TopDom Inferences
...
```
# Inter- and intra-species TAD Body Variance on Individual-level TopDom Inferences
...
```
# TAD Comparisons with data from Rao et al. 2014
